...
const Upload = () => {
    ...
    if (e.dataTransfer.files && e.dataTransfer.files[0]) {
      ...
      if (files.length > 0) {
        ...
        toast({
          ...
          description: `${files.length} فایل اکسل با موفقیت اضافه شد`,
        });
      } else {
        toast({
          title: "فرمت نامعتبر",
          description: "لطفا فقط فایل‌های اکسل آپلود کنید",
          variant: "destructive"
        });
      }
    }
  ...
  const processFiles = () => {
    ...
    toast({
      title: "در حال پردازش",
      description: "فایل‌ها در حال پردازش هستند...",
    });

    // In a real application, this would send files to backend
    setTimeout(() => {
      toast({
        title: "موفق",
        ...
        <Card className="border-primary/20">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge variant="outline">فرمت xlsx</Badge>
            </div>
            <Button 
        ...
        <CardContent>
          ...
          >
            ...
            <h3 className="text-lg font-medium mb-2">
              فایل‌های اکسل را اینجا بکشید یا کلیک کنید
            </h3>
